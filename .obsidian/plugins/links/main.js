...
var ObsidianLinksSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    const setLinkTestFromClipboardSetting = new import_obsidian5.Setting(containerEl).setName("Set link text from clipboard").setDesc("").addToggle((toggle) => {
    ...
    const toggleSetLinkTextFromClipboard = (enabled) => {
      if (enabled) {
    ...
    const convertHtmllinksToMdLinksSettings = new import_obsidian5.Setting(containerEl).setName("Convert HTML links to Markdown links").setDesc("").addToggle((toggle) => {
    ...
    const extractSectionSettings = new import_obsidian5.Setting(containerEl).setName("Extract section").setDesc("").addToggle((toggle) => {
    ...
    new import_obsidian5.Setting(containerEl).setName("Convert multiple links to markdown links").setDesc("Convert multiple links in note or selection to markdown links.").setClass("setting-item--insider-feature2").addToggle((toggle) => {
